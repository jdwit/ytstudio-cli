...
METRICS: dict[str, Metric] = {
    ...
    for m in [
        ...
        Metric(
            "estimatedRedMinutesWatched", "Minutes watched by YouTube Premium members", "watch_time"
        ),
        Metric(
            "averageViewDuration", "Average playback length in seconds", "watch_time", core=True
        ),
        ...
        Metric(
            "annotationClickThroughRate", "Annotation click-through rate", "annotations", core=True
        ),
        ...
        # Revenue metrics
        Metric(
            "estimatedRevenue", "Estimated total net revenue", "revenue", core=True, monetary=True
        ),
        ...
        Metric(
            "monetizedPlaybacks", "Playbacks that showed at least one ad", "revenue", monetary=True
        ),
        Metric(
            "playbackBasedCpm",
        ...
        Metric(
            "playlistEstimatedMinutesWatched", "Minutes watched in playlist context", "playlist"
        ),
        Metric(
...
DIMENSIONS: dict[str, Dimension] = {
    ...
    for d in [
        ...
        Dimension(
            "insightTrafficSourceDetail", "Specific traffic source (search term, URL)", "traffic"
        ),
        # Playback
        Dimension(
